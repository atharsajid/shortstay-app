...
class _BookingState extends State<Booking> {
  ...
  final _textFistNameController = TextEditingController(text:AppBloc.userCubit.state?.name.split(' ')[0]);
  final _textLastNameController = TextEditingController();
  final _textPhoneController = TextEditingController();
  final _textEmailController = TextEditingController(text: AppBloc.userCubit.state?.email);
  final _textAddressController = TextEditingController(text:AppBloc.userCubit.state?.address);
